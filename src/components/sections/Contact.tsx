...
const Contact = () => {
  return (
    <section id="contact" className="py-12 px-4 sm:px-6 bg-black/20">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-10 px-2 sm:px-0">
            ...
            <a
              ...
              className="flex flex-col items-center px-6 py-6 sm:p-8 bg-white/5 rounded-2xl hover:bg-white/10 transition-all duration-300 group border border-white/10 hover:border-[#0A66C2]/50 hover:shadow-2xl hover:shadow-[#0A66C2]/20 hover:-translate-y-2 hover:scale-105"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-col items-center px-6 py-6 sm:p-8 bg-white/5 rounded-2xl hover:bg-white/10 transition-all duration-300 group border border-white/10 hover:border-white/50 hover:shadow-2xl hover:shadow-white/20 hover:-translate-y-2 hover:scale-105"
            >
              <svg className="h-10 w-10 mb-4 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-col items-center px-6 py-6 sm:p-8 bg-white/5 rounded-2xl hover:bg-white/10 transition-all duration-300 group border border-white/10 hover:border-[#A6CE39]/50 hover:shadow-2xl hover:shadow-[#A6CE39]/20 hover:-translate-y-2 hover:scale-105"
            >
              ...
              <p className="text-slate-400 text-xs">Research profile</p>
            </a>
          </div>
